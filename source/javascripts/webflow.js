...
/***/ function(module, exports, __webpack_require__) {
	...
	Webflow.define('forms', module.exports = function($, _) {
	  ...
	  var formSpreeRegex = /formspree.io/i;
	  ...
	  function build(i, el) {
	    ...
	    // FormSpree form
	    if (formSpreeRegex.test(action)) { data.handler = submitFormSpree; return; }

	    // Custom form action
	    if (action) { data.handler = submitFormSpree; return; }
	  ...
	  function submitFormSpree(data) {
	    ...
	    $.ajax({
	      url: "https://formspree.io/christiaan@qbaylogic.com",
	      type: 'POST',
	      data: form.serialize(),
	      dataType: 'json'
	    }).done(function() {
